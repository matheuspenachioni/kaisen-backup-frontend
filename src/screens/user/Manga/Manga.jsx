        ...
        <main className="manga">
            <div>
                ...
                <span className="subtitle">
                    Jujutsu Kaisen Yuji é um gênio do atletismo, mas não tem interesse algum em ficar correndo em círculos.
                    Ele é feliz como membro no Clube de Estudo de Fenômenos Psíquicos. Apesar de estar no clube apenas por
                    diversão, tudo fica sério quando um espírito de verdade aparece na escola! A vida está prestes a se tornar
                ...
                <div className="chapters-container">
                    {chapters.map(chapter => (
                        ...
                        <div key={chapter.id} className="chapter-preview">
                            ...
                            <Link className="chapter-link" to={`/chapter/${chapter.id}`}>{chapter.title}</Link>
                        </div>
                    ))}
                </div>
            </div>
            <div>
                ...
                <span className="subtitle">Todas as capas oficiais do mangá em japonês, desde o prequel até o volume mais atual da história principal.</span>
